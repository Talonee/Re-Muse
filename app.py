...
class ReMuse(QMainWindow):
    def __init__(self):
        super(ReMuse, self).__init__()

        self.setGeometry(0, 0, 1280, 980)
        self.setWindowTitle("ReMuse")

        self.initUI()

    def initUI(self):
        self.label = QtWidgets.QLabel(self)
        self.label.setText("Welcome to Re-Muse")
        self.label.move(100, 100)
        self.update()

        self.b1 = QtWidgets.QPushButton(self)
        self.b1.setText("Browse")
        self.b1.clicked.connect(self.clicked)

    def clicked(self):
        self.label.setText("What the fuck is going onnnnnn")
        self.update()
...
## QtDesigner
# C:\Users\Cakee\AppData\Local\Programs\Python\Python37-32\Lib\site-packages\pyqt5_tools\Qt\bin

## Cmd line convert ui -> py file
